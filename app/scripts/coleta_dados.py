...
dados.to_csv('./input/adaptaBrasilAPIEstrutura.csv', sep='|', index=False)
sectoral_risk.to_csv('./input/sectoral_risk.csv', sep='|', index=False)
GeoHydrological_Disasters.to_csv('./input/GeoHydrological_Disasters.csv', sep='|', index=False)